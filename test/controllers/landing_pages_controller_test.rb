...
class LandingPagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create landing_page" do
    assert_difference('LandingPage.count') do
      post landing_pages_url, params: { landing_page: { author: @landing_page.author, genre: @landing_page.genre, price: @landing_page.price, publishedDate: @landing_page.publishedDate, title: @landing_page.title } }
    end
  ...
  test "should update landing_page" do
    patch landing_page_url(@landing_page), params: { landing_page: { author: @landing_page.author, genre: @landing_page.genre, price: @landing_page.price, publishedDate: @landing_page.publishedDate, title: @landing_page.title } }
